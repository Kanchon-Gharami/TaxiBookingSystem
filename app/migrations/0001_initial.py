# Generated by Django 3.2.2 on 2022-01-03 06:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('paymentMethod', models.CharField(choices=[('COD', 'Cash On Delivery')], default='COD', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickupDate', models.DateTimeField(default=datetime.datetime.now)),
                ('dropDate', models.DateTimeField(default=datetime.datetime.now)),
